...
export default function CreateRoom({onCreateRoom}) {
    ...
    return (
        <div style={{border: "1px solid black", width:"30%", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center"}}>
            ...
            <button onClick={() => onCreateRoom(roomName, password)}>Create Room!</button>
        </div>
    )
}
